...
import { TRANSCRIPTION_GUIDE } from './data/transcriptionGuide';
...
export const TRANSCRIPTION = TRANSCRIPTION_GUIDE;
export const PHRASES = PHRASES_DATA;
export const PROVERBS = PROVERBS_DATA;
