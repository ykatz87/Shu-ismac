...
import { SparklesIcon, LightBulbIcon, PlayIcon, LoadingSpinnerIcon } from './Icons';
...
// Flatten all verb forms into a single array for easier question generation
...
const VerbDrillView: React.FC<VerbDrillViewProps> = ({ onSuccess, onContinue }) => {
    ...
    const generateQuestion = useCallback(() => {
        ...
        const correctForm = allVerbForms[Math.floor(Math.random() * allVerbForms.length)];
        ...
        while (distractors.length < 3) {
            const randomForm = allVerbForms[Math.floor(Math.random() * allVerbForms.length)];
    ...
    return (
        <div className="max-w-3xl mx-auto">
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h3 className="text-2xl font-bold text-gray-800">שינון פעלים</h3>
                </div>
            ...
            <div className="bg-blue-50 border-r-4 border-blue-400 p-4 rounded-l-lg mb-6 text-right" dir="rtl">
                <div className="flex">
                ...
                <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4 transition-opacity duration-300 animate-fade-in">
                     <div className="bg-white p-8 rounded-2xl shadow-2xl text-center max-w-sm w-full transform transition-all animate-slide-up">
                        ...
                        <p className="text-lg text-gray-600 mb-6">
                            ענית על 10 שאלות ברצף! אפשר לעבור לתרגול שמות עצם.
                        </p>
